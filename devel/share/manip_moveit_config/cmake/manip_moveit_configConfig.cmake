...
if("TRUE" STREQUAL "TRUE")
  set(manip_moveit_config_SOURCE_PREFIX /home/user/catkin_ws/src/manip_moveit_config)
  set(manip_moveit_config_DEVEL_PREFIX /home/user/catkin_ws/devel)
  ...
  set(manip_moveit_config_INSTALL_PREFIX /home/user/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://moveit.ros.org/ " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'wada <a17.spc8@g.chuo-u.ac.jp>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'manip_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/catkin_ws/src/manip_moveit_config/${idir}'.  ${_report}")
    endif()
